...
![纸质书概览](index.assets/paper_book_overview.jpg){ class="animation-figure" }
...
![纸质书堆章节](index.assets/paper_book_chapter_heap.jpg){ class="animation-figure" }

![纸质书AVL树章节](index.assets/paper_book_avl_tree.jpg){ class="animation-figure" }
...
![购买二维码](index.assets/book_jd_link.jpg){ class="animation-figure" }
