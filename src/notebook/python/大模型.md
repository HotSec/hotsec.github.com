...
docker run -d --restart=always --name ollama -e OLLAMA_ENABLE_CUDA=1 -e OLLAMA_FLASH_ATTENTION=1 -e CUDA_VISIBLE_DEVICES=2,3 -e OLLAMA_KEEP_ALIVE=-1 -e OLLAMA_HOST=0.0.0.0 -e OLLAMA_MAX_LOADED_MODELS=4 -e OLLAMA_NUM_PARALLEL=10 -v /opt/ollama:/root/.ollama --gpus '"device=2,3"' -p 21434:11434 ollama/ollama
```
