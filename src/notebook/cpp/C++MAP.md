...
- [1. 基础](#1-基础)
  - [1.1. 常变量与数据类型](#11-常变量与数据类型)
    - [1.1.1. 变量作用域](#111-变量作用域)
    - [1.1.2. 生命周期](#112-生命周期)
    - [1.1.3. 修饰符](#113-修饰符)
  - [1.2. 程序流程控制](#12-程序流程控制)
    - [1.2.1. 条件语句](#121-条件语句)
    - [1.2.2. 循环语句](#122-循环语句)
    - [1.2.3. 跳转语句](#123-跳转语句)
  - [1.3. 运算符与表达式](#13-运算符与表达式)
    - [1.3.1. 算术运算符](#131-算术运算符)
    - [1.3.2. 关系运算符](#132-关系运算符)
    - [1.3.3. 逻辑运算符](#133-逻辑运算符)
    - [1.3.4. 位运算符](#134-位运算符)
    - [1.3.5. 赋值运算符](#135-赋值运算符)
    - [1.3.6. 其他运算符](#136-其他运算符)
  - [1.4. 数组](#14-数组)
    - [1.4.1. 一维数组](#141-一维数组)
    - [1.4.2. 多维数组](#142-多维数组)
    - [1.4.3. 数组与指针](#143-数组与指针)
    - [1.4.4. C风格字符串](#144-c风格字符串)
  - [1.5. 指针](#15-指针)
    - [1.5.1. 指针基础](#151-指针基础)
    - [1.5.2. 指针类型](#152-指针类型)
    - [1.5.3. 指针运算](#153-指针运算)
    - [1.5.4. nullptr (C++11)](#154-nullptr-c11)
    - [1.5.5. 函数指针](#155-函数指针)
    - [1.5.6. 指针数组与数组指针](#156-指针数组与数组指针)
  - [1.6. 引用](#16-引用)
  - [1.7. 函数](#17-函数)
  - [1.8. 函数重载](#18-函数重载)
    - [1.8.1. 重载规则](#181-重载规则)
    - [1.8.2. 重载解析](#182-重载解析)
    - [1.8.3. 重载二义性](#183-重载二义性)
  - [1.9. 字符串](#19-字符串)
    - [1.9.1. C风格字符串](#191-c风格字符串)
    - [1.9.2. std::string](#192-stdstring)
    - [1.9.3. Raw String (C++11)](#193-raw-string-c11)
    - [1.9.4. 字符串转换 (C++11)](#194-字符串转换-c11)
  - [1.10. 结构体](#110-结构体)
    - [1.10.1. 基本用法](#1101-基本用法)
    - [1.10.2. 结构体与类](#1102-结构体与类)
    - [1.10.3. 结构体对齐](#1103-结构体对齐)
  - [1.11. Union共用体](#111-union共用体)
    - [1.11.1. 基本概念](#1111-基本概念)
    - [1.11.2. 用途](#1112-用途)
    - [1.11.3. C++11 改进](#1113-c11-改进)
  - [1.12. Enum枚举](#112-enum枚举)
    - [1.12.1. C风格枚举](#1121-c风格枚举)
    - [1.12.2. 强类型枚举 (C++11)](#1122-强类型枚举-c11)
    - [1.12.3. 指定底层类型](#1123-指定底层类型)
    - [1.12.4. 枚举用法](#1124-枚举用法)
  - [1.13. 类型转换](#113-类型转换)
  - [1.14. 命名空间](#114-命名空间)
    - [1.14.1. 基本用法](#1141-基本用法)
    - [1.14.2. 命名空间特性](#1142-命名空间特性)
    - [1.14.3. 匿名命名空间](#1143-匿名命名空间)
    - [1.14.4. using 声明与指令](#1144-using-声明与指令)
  - [1.15. 文件操作](#115-文件操作)
    - [1.15.1. 文件流类](#1151-文件流类)
    - [1.15.2. 文件读写](#1152-文件读写)
    - [1.15.3. 打开模式](#1153-打开模式)
    - [1.15.4. 二进制文件](#1154-二进制文件)
    - [1.15.5. 文件位置指针](#1155-文件位置指针)
  - [1.16. 流](#116-流)
    - [1.16.1. 标准流对象](#1161-标准流对象)
    - [1.16.2. 流操纵符](#1162-流操纵符)
    - [1.16.3. 字符串流](#1163-字符串流)
    - [1.16.4. 流状态](#1164-流状态)
  - [1.17. 位运算](#117-位运算)
    - [1.17.1. 位运算符](#1171-位运算符)
    - [1.17.2. 常用操作](#1172-常用操作)
    - [1.17.3. 位域（Bit Fields）](#1173-位域bit-fields)
    - [1.17.4. 位运算应用](#1174-位运算应用)
  - [1.18. 异常处理](#118-异常处理)
    - [1.18.1. 基本语法](#1181-基本语法)
    - [1.18.2. 标准异常类](#1182-标准异常类)
    - [1.18.3. 自定义异常](#1183-自定义异常)
    - [1.18.4. 异常规范](#1184-异常规范)
    - [1.18.5. RAII 与异常安全](#1185-raii-与异常安全)
    - [1.18.6. 最佳实践](#1186-最佳实践)
  - [1.19. 预处理](#119-预处理)
  - [1.20. 动态库\&\&静态库](#120-动态库静态库)
    - [1.20.1. 静态库（Static Library）](#1201-静态库static-library)
    - [1.20.2. 动态库（Dynamic Library）](#1202-动态库dynamic-library)
    - [1.20.3. 编译选项](#1203-编译选项)
    - [1.20.4. 动态加载](#1204-动态加载)
  - [1.21. 信号处理](#121-信号处理)
- [2. CGI](#2-cgi)
  - [2.1. CGI 概述](#21-cgi-概述)
  - [2.2. CGI 环境变量](#22-cgi-环境变量)
  - [2.3. 简单 CGI 示例](#23-简单-cgi-示例)
  - [2.4. FastCGI](#24-fastcgi)
- [3. 内存管理](#3-内存管理)
  - [3.1. 堆](#31-堆)
  - [3.2. 栈](#32-栈)
  - [3.3. RAII](#33-raii)
- [4. 智能指针](#4-智能指针)
  - [4.1. unique\_ptr](#41-unique_ptr)
  - [4.2. shared\_ptr](#42-shared_ptr)
  - [4.3. weak\_ptr](#43-weak_ptr)
  - [4.4. auto\_ptr（已废弃）](#44-auto_ptr已废弃)
  - [4.5. 最佳实践](#45-最佳实践)
- [5. 移动语义](#5-移动语义)
  - [5.1. 左值与右值](#51-左值与右值)
    - [5.1.1. 左值 (lvalue)](#511-左值-lvalue)
    - [5.1.2. 右值 (rvalue)](#512-右值-rvalue)
  - [5.2. 右值引用](#52-右值引用)
  - [5.3. 移动构造与移动赋值](#53-移动构造与移动赋值)
  - [5.4. std::move](#54-stdmove)
  - [5.5. std::forward](#55-stdforward)
  - [5.6. 参考图](#56-参考图)
  - [5.7. 临时对象生命周期](#57-临时对象生命周期)
- [6. 函数调用约定](#6-函数调用约定)
- [7. 函数名修饰规则](#7-函数名修饰规则)
- [8. 开发环境](#8-开发环境)
  - [8.1. vs](#81-vs)
...
- [9. 类](#9-类)
  - [9.1. 构造函数](#91-构造函数)
    - [9.1.1. 默认构造函数](#911-默认构造函数)
    - [9.1.2. 参数化构造函数](#912-参数化构造函数)
    - [9.1.3. 拷贝构造函数](#913-拷贝构造函数)
    - [9.1.4. 移动构造函数 (C++11)](#914-移动构造函数-c11)
    - [9.1.5. 委托构造函数 (C++11)](#915-委托构造函数-c11)
  - [9.2. 析构函数](#92-析构函数)
    - [9.2.1. 基本概念](#921-基本概念)
    - [9.2.2. 虚析构函数](#922-虚析构函数)
    - [9.2.3. 析构函数调用顺序](#923-析构函数调用顺序)
    - [9.2.4. = default 和 = delete](#924--default-和--delete)
  - [9.3. 初始化参数列表(initializelist)](#93-初始化参数列表initializelist)
  - [9.4. this指针](#94-this指针)
    - [9.4.1. 基本概念](#941-基本概念)
    - [9.4.2. const 成员函数中的 this](#942-const-成员函数中的-this)
    - [9.4.3. 常见用途](#943-常见用途)
  - [9.5. 返回值优化](#95-返回值优化)
  - [9.6. 成员函数](#96-成员函数)
    - [9.6.1. 内联成员函数](#961-内联成员函数)
    - [9.6.2. const 成员函数](#962-const-成员函数)
    - [9.6.3. volatile 成员函数](#963-volatile-成员函数)
    - [9.6.4. 引用限定符 (C++11)](#964-引用限定符-c11)
    - [9.6.5. 成员函数指针](#965-成员函数指针)
  - [9.7. const修饰类](#97-const修饰类)
  - [9.8. static修饰类](#98-static修饰类)
  - [9.9. 友元friend](#99-友元friend)
  - [9.10. 运算符重载](#910-运算符重载)
  - [9.11. 继承](#911-继承)
    - [9.11.1. 继承方式](#9111-继承方式)
    - [9.11.2. 构造与析构顺序](#9112-构造与析构顺序)
    - [9.11.3. 虚继承](#9113-虚继承)
    - [9.11.4. 虚继承的构造函数](#9114-虚继承的构造函数)
- [10. 多态](#10-多态)
  - [10.1. 虚函数](#101-虚函数)
  - [10.2. 纯虚函数](#102-纯虚函数)
  - [10.3. 编译期多态](#103-编译期多态)
- [11. 委托构造](#11-委托构造)
  - [11.1. 基本概念](#111-基本概念)
  - [11.2. 注意事项](#112-注意事项)
  - [11.3. 用途](#113-用途)
- [12. 模板](#12-模板)
  ...
  - [12.2. 模板类](#122-模板类)
- [13. 模板元编程](#13-模板元编程)
  - [13.1. enable\_if](#131-enable_if)
  - [13.2. void\_t](#132-void_t)
  - [13.3. 函数模板](#133-函数模板)
    - [13.3.1. 模板泛化](#1331-模板泛化)
    - [13.3.2. 模板参数推导](#1332-模板参数推导)
  - [13.4. 类模板](#134-类模板)
  - [13.5. 模板特化](#135-模板特化)
    - [13.5.1. 完全特化](#1351-完全特化)
    - [13.5.2. 偏特化](#1352-偏特化)
  - [13.5. 模板特化](#135-模板特化-1)
  - [13.6. 应用可变模板](#136-应用可变模板)
  - [13.7. tuple](#137-tuple)
    - [13.7.1. 基本用法](#1371-基本用法)
    - [13.7.2. 解包](#1372-解包)
    - [13.7.3. 拼接与比较](#1373-拼接与比较)
- [14. 常量表达式constexpr](#14-常量表达式constexpr)
- [15. 函数式编程](#15-函数式编程)
  - [15.1. C++98的函数对象 functor](#151-c98的函数对象-functor)
  - [15.2. lambda表达式](#152-lambda表达式)
    - [15.2.1. 基本语法](#1521-基本语法)
    - [15.2.2. 捕获方式](#1522-捕获方式)
    - [15.2.3. mutable lambda](#1523-mutable-lambda)
    - [15.2.4. 泛型 lambda (C++14)](#1524-泛型-lambda-c14)
  - [15.3. 泛型lambda表达式](#153-泛型lambda表达式)
  - [15.4. bind模板](#154-bind模板)
  - [15.5. function模板](#155-function模板)
  - [15.5. function模板](#155-function模板-1)
  - [15.6. 高阶函数](#156-高阶函数)
- [16. 并发](#16-并发)
  - [16.1. 线程管理](#161-线程管理)
    - [16.1.1. 启动新线程](#1611-启动新线程)
    - [16.1.2. 线程所有权转移](#1612-线程所有权转移)
    - [16.1.3. 线程管理](#1613-线程管理)
  - [16.2. 线程同步](#162-线程同步)
    - [16.2.1. 互斥量（Mutexes）](#1621-互斥量mutexes)
    - [16.2.2. 锁（Locks）](#1622-锁locks)
    - [16.2.3. 条件变量（Condition Variables）](#1623-条件变量condition-variables)
  - [16.3. 读写锁（Read-Write Locks）](#163-读写锁read-write-locks)
    - [16.3.1. 原子操作（Atomic Operations）](#1631-原子操作atomic-operations)
    - [16.3.2. 屏障（Barriers）](#1632-屏障barriers)
    - [16.3.3. std::latch](#1633-stdlatch)
    - [16.3.4. Futures和Promises](#1634-futures和promises)
      - [16.3.4.1. std::promise](#16341-stdpromise)
      - [16.3.4.2. 主要成员函数：](#16342-主要成员函数)
      - [16.3.4.3. std::future](#16343-stdfuture)
        - [16.3.4.3.1. 主要成员函数：](#163431-主要成员函数)
      - [16.3.4.4. 示例](#16344-示例)
  - [16.4. 有锁的并发数据结构](#164-有锁的并发数据结构)
    - [16.4.1. 选择合适的锁类型](#1641-选择合适的锁类型)
    - [16.4.2. 确定锁的作用域和粒度](#1642-确定锁的作用域和粒度)
    - [16.4.3. 设计原则](#1643-设计原则)
    - [16.4.4. 示例：基于锁的线程安全队列](#1644-示例基于锁的线程安全队列)
  - [16.5. 无锁的并发数据结构](#165-无锁的并发数据结构)
    - [16.5.1. 关键概念](#1651-关键概念)
    - [16.5.2. 示例：无锁栈](#1652-示例无锁栈)
  - [16.6. 注意事项](#166-注意事项)
  - [16.7. 并发设计](#167-并发设计)
  - [16.8. 线程池](#168-线程池)
  - [16.9. 并行算法](#169-并行算法)
  - [16.10. 多线程调试](#1610-多线程调试)
- [17. 内存模型和atomic](#17-内存模型和atomic)
  - [17.1. 内存模型](#171-内存模型)
    - [17.1.1. 内存顺序](#1711-内存顺序)
    - [17.1.2. Happens-Before 关系](#1712-happens-before-关系)
  - [17.2. atomic 类型](#172-atomic-类型)
  - [17.3. atomic\_flag](#173-atomic_flag)
  - [17.4. 自旋锁实现](#174-自旋锁实现)
- [18. 工具](#18-工具)
  - [18.1. 编译器](#181-编译器)
  - [18.2. 构建系统](#182-构建系统)
    - [18.2.1. CMake](#1821-cmake)
    - [18.2.2. Make](#1822-make)
  - [18.3. 调试工具](#183-调试工具)
  - [18.4. 代码分析](#184-代码分析)
  - [18.5. 包管理](#185-包管理)
- [19. 单元测试](#19-单元测试)
  - [19.1. Google Test](#191-google-test)
  - [19.2. Catch2](#192-catch2)
  - [19.3. CTest](#193-ctest)
- [20. Qt](#20-qt)
  - [20.1. 基本概念](#201-基本概念)
  - [20.2. 信号与槽](#202-信号与槽)
  - [20.3. 事件处理](#203-事件处理)
  - [20.4. 布局管理](#204-布局管理)
  - [20.5. Qt 容器类](#205-qt-容器类)
- [21. STL](#21-stl)
  - [21.1. vector](#211-vector)
    - [21.1.1. 基本用法](#2111-基本用法)
    - [21.1.2. 性能特点](#2112-性能特点)
    - [21.1.3. 避免迭代器失效](#2113-避免迭代器失效)
  - [21.2. deque](#212-deque)
  - [21.3. list](#213-list)
  - [21.4. forward\_list](#214-forward_list)
  - [21.5. queue](#215-queue)
  - [21.6. stack](#216-stack)
  - [21.7. priority\_queue](#217-priority_queue)
  - [21.8. less](#218-less)
  - [21.9. greater](#219-greater)
  - [21.10. hash](#2110-hash)
  - [21.11. 关联容器](#2111-关联容器)
    - [21.11.1. set 集合](#21111-set-集合)
    - [21.11.2. map 映射](#21112-map-映射)
    - [21.11.3. multiset 多重集](#21113-multiset-多重集)
    - [21.11.4. multimap 多重映射](#21114-multimap-多重映射)
  - [21.12. 无序关联容器](#2112-无序关联容器)
    - [21.12.1. unordered\_set](#21121-unordered_set)
    - [21.12.2. unordered\_map](#21122-unordered_map)
    - [21.12.3. unordered\_multiset](#21123-unordered_multiset)
    - [21.12.4. unordered\_multimap](#21124-unordered_multimap)
  - [21.13. array](#2113-array)
  - [22.3. 字符编码转换](#223-字符编码转换)
  - [22.4. 本地化](#224-本地化)
- [23. 数据结构与算法](#23-数据结构与算法)
  - [23.1. 标准算法](#231-标准算法)
  - [23.2. 常用数据结构](#232-常用数据结构)
    - [23.2.1. 链表](#2321-链表)
    - [23.2.2. 二叉树](#2322-二叉树)
    - [23.2.3. 图](#2323-图)
  - [23.3. 复杂度分析](#233-复杂度分析)
- [24. 常用库](#24-常用库)
  - [24.1. libevent](#241-libevent)
  - [24.2. boost](#242-boost)
    - [24.2.1. 常用组件](#2421-常用组件)
  - [24.3. OpenCV](#243-opencv)
  - [24.4. OpenSSL](#244-openssl)
  - [24.5. nlohmann/json](#245-nlohmannjson)
  - [24.6. gRPC](#246-grpc)
- [25. 日志库](#25-日志库)
  - [25.1. spdlog](#251-spdlog)
  - [25.2. glog](#252-glog)
  - [25.3. log4cpp](#253-log4cpp)
- [26. 数字计算](#26-数字计算)
  - [26.1. 数学函数](#261-数学函数)
  - [26.2. 随机数](#262-随机数)
  - [26.3. 复数](#263-复数)
  - [26.4. 数值数组](#264-数值数组)
  - [26.5. C++ REST SDK (cpprestsdk)](#265-c-rest-sdk-cpprestsdk)
- [27. Concepts 模板约束](#27-concepts-模板约束)
  - [27.1. 基本概念](#271-基本概念)
  - [27.2. 标准 Concepts](#272-标准-concepts)
  - [27.3. 自定义 Concept](#273-自定义-concept)
  - [27.4. requires 子句](#274-requires-子句)
- [28. Ranges](#28-ranges)
  - [28.1. 基本概念](#281-基本概念)
  - [28.2. Views（视图）](#282-views视图)
  - [28.3. Range Adaptors（范围适配器）](#283-range-adaptors范围适配器)
  - [28.4. Ranges 算法](#284-ranges-算法)
  - [28.5. 投影（Projection）](#285-投影projection)
- [29. Coroutines 协程](#29-coroutines-协程)
  - [29.1. 基本概念](#291-基本概念)
  - [29.2. 协程返回类型](#292-协程返回类型)
  - [29.3. Awaitable 类型](#293-awaitable-类型)
  - [29.4. 简单生成器示例](#294-简单生成器示例)
  - [29.5. 协程注意事项](#295-协程注意事项)
- [30. 虚拟内存](#30-虚拟内存)
  - [30.1. 基本概念](#301-基本概念)
  - [30.2. 内存分页](#302-内存分页)
  - [30.3. 内存分段](#303-内存分段)
  - [30.4. 虚拟内存区域](#304-虚拟内存区域)
  - [30.5. 内存映射文件](#305-内存映射文件)
- [31. 汇编](#31-汇编)
  - [31.1. 内联汇编](#311-内联汇编)
  - [31.2. 常见汇编指令](#312-常见汇编指令)
  - [31.3. 调用约定](#313-调用约定)
  - [31.4. 查看汇编代码](#314-查看汇编代码)
- [32. 参考资料](#32-参考资料)
...
```cpp
#pragma pack(push, 1)  // 保存当前的对齐设置，设置新的对齐值为 1
struct Packed {
    char a;   // 1
    int b;    // 4
};    // sizeof = 5
...
#pragma pack(n)  // 直接设置对齐值为n（不推荐，影响全局）
...
// 成员级别对齐
struct MemberAlign {
    alignas(16) int a;     // a 对齐到 16 字节
    alignas(8) double b;   // b 对齐到 8 字节
    int c;                 // 默认对齐
};
```
